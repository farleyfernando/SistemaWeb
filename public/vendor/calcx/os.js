...
if ($counter > 0) {
    ...
    $('#table_servicos tr').each(function() {
        ...
        /*Caso não exista (false), adiciona o serviço no array 'servicos_adicionados'*/
        if (result_add == false) {
...
$(document).ready(function() {
    ...
    $("#buscar_servicos").autocomplete({
        ...
        select: function(event, ui) {
            ...
            if (ui.item.value === 'Serviço não localizado !!!') {
                return false;
            } else {
