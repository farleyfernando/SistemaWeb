...
class Clientes extends CI_Controller
{
    ...
    public function editar($cliente_id = null)
    {
        if (!$cliente_id || !$this->core_model->get_by_id('clientes', ['cliente_id' => $cliente_id])) {
            ...
            $this->form_validation->set_rules('cliente_rg_ie', '', 'trim|required|max_length[20]|callback_rg_ie_check');

            $this->form_validation->set_rules('cliente_email', '', 'trim|required|valid_email|max_length[50]|callback_email_check');
            ...
            if ($this->form_validation->run()) {
                ...
                //erro de validação
                $data = [
                    'titulo' => 'Atualizar dados Clientes',
