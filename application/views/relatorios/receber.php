              ...
              <fieldset class="mt-4 border p-2">
                  ...
                  <div class="form-group row pt-3 pl-3">
                      <div class="custom-control custom-radio col offset-md-1 mb-2">
                          ...
                          <label class="custom-control-label pt-1" for="customRadio1">Contas pagas</label>
                      </div>
                      <div class="custom-control custom-radio ml-auto col mb-2">
                          ...
                          <label class="custom-control-label pt-1" for="customRadio2">Contas a receber</label>
                      </div>
                      <div class="custom-control custom-radio ml-auto col">
                          ...
                          <label class="custom-control-label pt-1" for="customRadio3">Contas vencidas</label>
                      </div>
