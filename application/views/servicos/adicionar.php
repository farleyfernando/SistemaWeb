    ...
    <?php $this->load->view('layout/navbar'); ?>    
        ...
        <div class="container-fluid">  
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="<?php echo base_url('servicos'); ?>">Serviço</a></li>
                  ...
                  <legend class="" style="font-size:17px"><i class="fas fa-tools"></i>&nbsp; Dados do Serviço</legend>
                      <div class="form-group row">
                        ...
                        <div class="col-md-4">
                          <label>Valor do Serviço</label>
                            <input type="text" class="form-control money" name="servico_preco" placeholder="Valor" value="<?php echo set_value('servico_preco'); ?>">
                      ...
                      <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <textarea type="text" class="form-control" name="servico_descricao" style="max-height: 100px;min-width: 100px" placeholder="Descrição"><?php echo set_value('servico_descricao'); ?></textarea>
