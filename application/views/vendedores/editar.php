                  ...
                  <legend class="" style="font-size:17px"><i class="fas fa-user-secret"></i>&nbsp; Dados Vendedor</legend>
                      <div class="form-group row">
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="col-md-2">
                            ...
                            <input type="date" class="form-control" name="vendedor_dn" placeholder="Data Nasc." value="<?php echo $vendedor->vendedor_dn; ?>">
                      ...
                      <div class="form-group row">
                          <div class="col-md-4">
                            ...
                            <input type="text" class="form-control phone_with_ddd" name="vendedor_telefone" placeholder="Tel. fixo" value="<?php echo $vendedor->vendedor_telefone; ?>">
                  ...
                  <div class="form-group row">
                    <div class="col-md-4">
                      ...
                      <div class="col-md-4">
                          ...
                          <input type="text" class="form-control" name="vendedor_obs" placeholder="Código" value="<?php echo $vendedor->vendedor_codigo; ?>" readonly="" >
                          <?php echo form_error('vendedor_codigo', '<small class="form-text text-danger">', '</small>'); ?>
                      </div>
                      <div class="col-md-4">
                          <label>Obs</label>
                          <input type="text" class="form-control" name="vendedor_obs" placeholder="Observações" value="<?php echo $vendedor->vendedor_obs; ?>">
