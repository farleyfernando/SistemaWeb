...
<fieldset id="vendas" class="mt-4 border p-2">
    ...
    <legend class="font-small">Informações da Venda</legend>
        ...
        <table id="table_produtos" class="table">
            ...
            <tbody id="lista_produtos" class="item">
                ...
                <?php foreach ($venda_produtos as $venda_produto): ?>
                    ...
                    <tr>                                                    
                        <td><input type="hidden" name="produto_id[]" value="<?php echo $venda_produto->venda_produto_id_produto; ?>" data-cell="A<?php echo $i; ?>" data-format="0" disabled></td>

                        <td><input title="Descrição do produto" type="text" name="produto_descricao[]" value="<?php echo $venda_produto->produto_descricao; ?>" class="produto_descricao form-control form-control-user input-sm" data-cell="B<?php echo $i; ?>" disabled></td>

                        <td><input title="Valor unitário do produto" name="produto_preco_venda[]" value="<?php echo $venda_produto->venda_produto_valor_unitario; ?>" class="form-control form-control-user input-sm text-right money pr-1" data-cell="C<?php echo $i; ?>" data-format="R$ 0,0.00" disabled></td>

                        <td><input title="Digite a quantidade apenas em número inteiros" type="text" inputmode="numeric" pattern="[-+]?[0-9]*[.,]?[0-9]+" name="produto_quantidade[]" value="<?php echo $venda_produto->venda_produto_quantidade; ?>" class="qty form-control form-control-user text-center" data-cell="D<?php echo $i; ?>" data-format="0[.]00" required disabled></td>
                        
                        <td><input title="Insira o desconto" name="produto_desconto[]" class="form-control form-control-user input-sm text-right" value="<?php echo $venda_produto->venda_produto_desconto; ?>" data-cell="E<?php echo $i; ?>" data-format="0,0[.]00 %" required disabled></td>

                        <td><input title="Valor total do produto selecionado" name="produto_item_total[]" value="<?php echo $venda_produto->venda_produto_valor_total; ?>" class="form-control form-control-user input-sm text-right pr-1" data-cell="F<?php echo $i; ?>" data-format="R$ 0,0.00" data-formula="D<?php echo $i; ?>*(C<?php echo $i; ?>-(C<?php echo $i; ?>*E<?php echo $i; ?>))" disabled></td>

                        <td class="text-center"><input type="hidden" name="valor_desconto_produto[]" data-cell="H<?php echo $i; ?>"  data-format="R$ 0,0.00" data-formula="((C<?php echo $i; ?>*D<?php echo $i; ?>)-F<?php echo $i; ?>)"><button title="Remover o produto" class="btn-remove btn btn-sm btn-danger" disabled><i class="fas fa-trash-alt"></i></button></td>
                    </tr>
            ...
            <tfoot >
                <tr class="">
                    ...
                    <td class="text-right border-0">
                        <input type="text" name="venda_valor_desconto" class="form-control form-control-user text-right pr-1" data-format="$ 0,0.00" data-cell="L1" data-formula="SUM(H1:H5)" disabled>
                    </td>
                ...
                <tr class="">
                    ...
                    <td class="text-right border-0">
                        <input type="text" name="venda_valor_total" class="form-control form-control-user text-right pr-1" data-format="$ 0,0.00" data-cell="G2" data-formula="SUM(F1:F5)" disabled>
                    </td>
                    <td class="border-0">&nbsp;</td>
                </tr>
            </tfoot>
...
<fieldset class="mt-4 border p-2">
    ...
    <legend class="font-small">Cliente/Forma de Pgto</legend>

    <div class="">
        <div class="form-group row">

            <div class="col-sm-6 mb-1 mb-sm-0">
                <label class="small my-0">Cliente <span class="text-danger">*</span></label>
            ...
            <div class="col-sm-6 mb-1 mb-sm-0">
                ...
                <select class="custom-select vendedor" name="venda_tipo" required="" disabled>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <label class="small my-0">Vendedor <span class="text-danger">*</span></label>
...
<div class="mt-3">
    <!--<button class="btn btn-success mr-2" id="btn-cadastrar-venda" form="form" <?php echo ($desabilitar == TRUE ? 'disabled' : ''); ?>><?php echo ($desabilitar == TRUE ? 'Venda Encerrada' : '<i class="far fa-save ml-1"></i>&nbsp;Salvar'); ?></button>-->
    <a href="<?php echo base_url('vendas'); ?>" class="btn btn-primary"><i class="fas fa-arrow-left"></i>&nbsp;Voltar</a>
</div>
