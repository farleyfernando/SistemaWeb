            ...
            <form class="user" action="" id="form" name="form_add" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                            ...
                            <table id="table_produtos" class="table">
                                ...
                                <tfoot >
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="text-right border-0">
                                            <input type="text" name="venda_valor_total" class="form-control form-control-user text-right pr-1" data-format="$ 0,0.00" data-cell="G2" data-formula="SUM(F1:F5)" readonly="" required>
                                        </td>
                                        <td class="border-0">&nbsp;</td>
                                    </tr>
                                </tfoot>
                        ...
                        <div class="">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 mb-1 mb-sm-0">
                                    ...
                                    <select class="form-control" id="venda_tipo" name="venda_tipo" required="">
                                        <option value="">Escolha...</option>
                    ...
                    <div class="mt-3">
                      <button type="submit" class="btn btn-success"><i class="far fa-save ml-1"></i>&nbsp; Salvar</button>
                          <a title="Voltar" href="<?php echo base_url('vendas')?>" class="btn btn-primary ml-2"><i class="fas fa-arrow-left"></i>&nbsp; Voltar</a>
                    </div>
