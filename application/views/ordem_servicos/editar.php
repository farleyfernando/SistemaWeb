    ...
    <?php $this->load->view('layout/navbar'); ?>    
        ...
        <div class="container-fluid">  
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="<?php echo base_url('os'); ?>">Ordem de Serviço</a></li>
...
<div class="mt-3">
    <button class="btn btn-success mr-2" id="btn-cadastrar-venda" form="form" <?php echo ($ordem_servico->ordem_servico_status == 1 ? 'disabled' : ''); ?>><?php echo ($ordem_servico->ordem_servico_status == 1 ? 'Paga' : '<i class="far fa-save ml-1"></i>&nbsp;Salvar'); ?></button>
    <a href="<?php echo base_url('os'); ?>" class="btn btn-primary"><i class="fas fa-arrow-left"></i>&nbsp;Voltar</a>
</div>
