...
<html lang="pt">
    ...
    <head>
        ...
        <?php echo (isset($titulo) ? '<title>Cat"s Moda | ' . $titulo . '</title>' : '<title>Cat"s Moda</title>') ?>
        ...
        <div id="wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- 404 Error Text -->
                    ...
                    <div class="text-danger font-weight-bold" style="font-size: 30px;" data-text="404">ERRO</div>
