        ...
        <div class="container-fluid">  
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <a title="Cadastrar categoria" href="<?php echo base_url('categorias/adicionar'); ?>" class="btn btn-success float-right"><i class="fas fa-plus"></i></i>&nbsp; Novo</a>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center pr-1">
                        <a title="Editar categoria" href="<?php echo base_url('categorias/editar/'.$categoria->categoria_id); ?>" class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
                        <a title="Excluir Usuário"href="javascript(void)" data-toggle="modal" data-target="#categoria-<?php echo $categoria->categoria_id; ?>"class="btn btn-sm btn-danger"><i class="fas fa-user-times"></i></a>
                      </td> 
